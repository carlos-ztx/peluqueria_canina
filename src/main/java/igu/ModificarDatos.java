...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    public ModificarDatos(int num_dueno) {
        controladora = new Controladora();
        initComponents();
        cargarDatos(num_dueno);
    ...
    private void initComponents() {
        ...
        btnGuardar.setToolTipText("Guarda los Cambios de la Mascota Seleccionada.");
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon("C:\\Users\\Personal\\Downloads\\gato.png")); // NOI18N
    ...
    private void lblLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLogoMouseClicked
        if (NoHayDatosSinGuardar()) {
            ...
            int respuesta = JOptionPane.showConfirmDialog(rootPane, "Hay datos en los campos ¿Desea salir de todas formas?", "Advertencia", JOptionPane.YES_NO_OPTION);
            if (respuesta == 0) {
                VerDatos v = null;
                v = new VerDatos();
                v.setVisible(true);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        controladora.editarDatos(mascota, nombreMascota, raza, color, observaciones, alergico, especial, nombreDueno, celDueno);
    ...
    private void cargarDatos(int num_dueno) {
        this.mascota = controladora.traerMascota(num_dueno);
        txtNombre.setText(mascota.getNombre());
        txtRaza.setText(mascota.getRaza());
        txtColor.setText(mascota.getColor());
        cmbAlergico.setSelectedItem(mascota.getAlergico());
        cmbAtencionEspecial.setSelectedItem(mascota.getAtencionEspecial());
        txtNomDueno.setText(mascota.getDueno().getNombre());
        txtCelDueno.setText(mascota.getDueno().getCelDueno());
        aTxtObservaciones.setText(mascota.getObservaciones());
    }
